...
@Schema(name = "BankCustomerCardStepRequest", description = "Step 3 payload for saving bank customer card details.")
public record BankCustomerCardStepRequest(
	...
	@Schema(name = "BankCustomerCardItem", description = "Single card row in the card step.")
