...
public class TransactionController {
	...
	@Operation(
		...
		description = "Creates a transaction for the logged-in BANK_CUSTOMER and issues a 6-digit OTP (valid for 5 minutes) via transactional email. Sender ownership is resolved from authenticated context (/api/auth/me bankCustomerId). Validates receiver account existence, that the beneficiary name matches the registered account holder, transfer amount <= Rs.100,000.00, and minimum remaining sender balance Rs.1,000.00.",
		responses = {
