...
public class BranchController {
	...
	@Operation(
		...
		description = "Creates a new bank branch.",
		responses = {
	...
	@GetMapping("/{branchId}")
	@Operation(summary = "Get branch by id", description = "Returns a branch by id.")
	...
	@PutMapping("/{branchId}")
	@Operation(summary = "Update branch", description = "Updates full branch details.")
	...
	@Operation(summary = "Update branch status", description = "Updates branch status to ACTIVE or INACTIVE.")
